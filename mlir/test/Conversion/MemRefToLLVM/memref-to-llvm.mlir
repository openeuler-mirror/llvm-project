...
func.func @generic_atomic_rmw_f16(%I : memref<10xf16>, %i : index) {
...
// Verify that float operands are bitcast to integers for llvm.cmpxchg (which
// only accepts integer/pointer types) and cast back to float in the end block.
