...
public:
  ...
  LogicalResult matchAndRewrite(vector::OuterProductOp op,
	...
	auto fmf = LLVM::FastmathFlagsAttr::get(rewriter.getContext(),
                                                LLVM::FastmathFlags::none);
        auto lhsdup = rewriter.create<LLVM::CallIntrinsicOp>(
            loc, TypeRange{vectype}, dupq, ValueRange{ScalableLhs, i0}, fmf);
        ...
        fma = rewriter.create<LLVM::CallIntrinsicOp>(
            ...
            ValueRange{r, rhs, broadcastedLHS, idx}, fmf);
