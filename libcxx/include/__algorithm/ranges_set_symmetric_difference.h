...
struct __fn {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI constexpr set_symmetric_difference_result<_InIter1, _InIter2, _OutIter> operator()(
      _InIter1 __first1,
      _Sent1 __last1,
      _InIter2 __first2,
      _Sent2 __last2,
  ...
  template <
    ...
    requires mergeable<
        ...
        _Proj1,
        _Proj2> 
  _LIBCUDACXX_HIDE_FROM_ABI constexpr set_symmetric_difference_result<borrowed_iterator_t<_Range1>,
