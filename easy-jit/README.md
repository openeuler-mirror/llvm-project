...
```bash
apt install llvm-19-dev llvm-19-tools clang-19
## or in OpenEuler
dnf install llvm-toolset-19 llvm-toolset-19-llvm-devel llvm-toolset-19-mlir-devel
```

Then, configure and compile the project.

```bash
cmake -DLLVM_DIR=/usr/lib/llvm-19/cmake <path_to_easy_jit_src>
cmake --build .
## or in OpenEuler
cmake -DLLVM_DIR=/opt/openEuler/llvm-toolset-19/root/usr/lib64/cmake <path_to_easy_jit_src>
cmake --build .
```
