#ifndef LLVM_ADT_ARRAYVIEW_H
#define LLVM_ADT_ARRAYVIEW_H

template <typename ArrayBaseType> class ArrayView {
public:
...
public:
  ...
  ArrayView(iterator Begin, iterator End, reverse_iterator RBegin,
            reverse_iterator REnd)
  ...
  value_type &operator[](size_t Index) { return *(Begin + Index); }
};
