...
; CHECK-NEXT:    [[INCDEC_PTR]] = getelementptr inbounds i8, ptr [[P_ADDR]], i64 4
...
while.body:
  ...
  %incdec.ptr = getelementptr inbounds i8, ptr %p.addr, i64 4
...
; CHECK-NEXT:    [[SRC_VAL_NEXT:%.*]] = getelementptr inbounds i8, ptr [[SRC_VAL]], i64 1
; CHECK-NEXT:    [[DST_VAL_NEXT]] = getelementptr inbounds i8, ptr [[DST_VAL]], i64 1
...
while.body:
  ...
  %src_val.next = getelementptr inbounds i8, ptr %src_val, i64 1
  %dst_val.next = getelementptr inbounds i8, ptr %dst_val, i64 1
