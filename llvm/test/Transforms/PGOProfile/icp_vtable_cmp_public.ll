...
; Tests that ICP compares vtables by checking IR and using the llvm.public.type.test intrinsic instead of the llvm.type.test intrinsic.
...
; VTABLE-CMP-NEXT:    [[TMP0:%.*]] = tail call i1 @llvm.public.type.test(ptr [[VTABLE]], metadata !"Base1")
...
; FUNC-CMP-NEXT:    [[TMP0:%.*]] = tail call i1 @llvm.public.type.test(ptr [[VTABLE]], metadata !"Base1")
...
entry:
  ...
  %0 = tail call i1 @llvm.public.type.test(ptr %vtable, metadata !"Base1")
