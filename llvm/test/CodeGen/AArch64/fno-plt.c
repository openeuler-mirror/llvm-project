// REQUIRES: aarch64-register-target
...
// RUN: clang %s -shared -O0 -fPIC -o plt.so
...
__attribute__((optnone)) void bar(int a) {
  return;
}

__attribute__((optnone)) extern void bar1(int);

__attribute__((optnone)) void bar2(int a) {
  return;
}
