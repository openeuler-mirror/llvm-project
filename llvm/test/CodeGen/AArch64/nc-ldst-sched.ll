; RUN: llc < %s -pgo-sched-hints-file=%S/nc-ldst-sched.afdo | FileCheck %s
...
attributes #0 = { nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable "frame-pointer"="non-leaf" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+fp-armv8,+neon,+v8a,-fmv" }
...
; NOSCHED: ldr w12, [x1, #32]
; NOSCHED: str w9, [x1, #32]
; NOSCHED: ldr w13, [x1, #48]
; NOSCHED: ldr w10, [x1, #64]
; NOSCHED: str w9, [x1, #48]
; NOSCHED: ldr w12, [x1, #80]
