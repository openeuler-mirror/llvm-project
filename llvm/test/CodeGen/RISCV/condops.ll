...
; RUN: llc -mtriple=riscv32 -target-abi=ilp32f -mattr=+f,+zicond < %s | FileCheck %s -check-prefix=RV32ZICOND
; RUN: llc -mtriple=riscv64 -target-abi=lp64f -mattr=+f,+zicond < %s | FileCheck %s -check-prefix=RV64ZICOND
