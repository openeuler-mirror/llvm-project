...
// GENERICV96A: "-cc1"{{.*}} "-triple" "aarch64{{.*}}" "-target-cpu" "generic{{.*}}" "-target-feature" "+neon" "-target-feature" "+v9.6a"
...
// GENERICV96A-BE: "-cc1"{{.*}} "-triple" "aarch64_be{{.*}}" "-target-cpu" "generic{{.*}}" "-target-feature" "+neon" "-target-feature" "+v9.6a"{{.*}}
